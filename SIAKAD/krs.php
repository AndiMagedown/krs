...
<div class="container">
  ...
  <table class="table table-striped">
    ...
    include('koneksi.php');
    $no = 1;
    $query = mysqli_query($conn, "SELECT tb_mahasiswa.nim , tb_mahasiswa.nama , tb_mahasiswa.prodi, tb_mk.nama_matakuliah, tb_mk.jadwal_kuliah , tb_mk.ruang_kuliah , tb_dosen.nama_dosen FROM tb_mahasiswa INNER JOIN tb_mk INNER JOIN tb_dosen");
